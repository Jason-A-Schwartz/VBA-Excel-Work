# Jason Schwartz
# CINF 308 Midterm Project Part Three

# Description:
# This program prints out the correct syntax for VBA and the correct data values for the third set of 25 (making 75)
...
while (EFGAOcount < 123):
    ...
    print('If Range("BL' + str(Vcount) + '") = "" Then')

    # This spaces out the section of code from the rest
    print()

    # This prints out the EFGAOcount variable and the HIcount variable with the correct VBA syntax
    print('Range("EL' + str(EFGAOcount) + '").Value = Sheets("Kalamein Shop").Range("V' + str(HIcount) + '")')

    # This prints out the EFGAOcount variable and the HIcount variable with the correct VBA syntax
    print('Range("EM' + str(EFGAOcount) + '").Value = Sheets("Kalamein Shop").Range("W' + str(HIcount) + '")')
    
    # This prints out the EFGAOcount variable and the HIcount variable with the correct VBA syntax
    print('Range("FE' + str(EFGAOcount) + '").Value = Sheets("Assembly").Range("W' + str(HIcount) + '")')
    
    # This prints out the OFFcountone variable and the OFFcounttwo variable with the correct VBA syntax
    print('Range("FE' + str(OFFcountone) + '").Value = Sheets("Assembly").Range("W' + str(OFFcounttwo) + '")')
    
    # This prints out the EFGAOcount variable and the HIcount variable with the correct VBA syntax
    print('Range("FS' + str(EFGAOcount) + '").Value = Sheets("Prehang").Range("W' + str(HIcount) + '")')
    
    # This prints out the OFFcountone variable and the OFFcounttwo variable with the correct VBA syntax
    print('Range("FS' + str(OFFcountone) + '").Value = Sheets("Prehang").Range("W' + str(OFFcounttwo) + '")')
    
    # This spaces out the section of code from the rest
    print()
    
    # This prints out the Vcount variable with the correct VBA syntax
    print('ElseIf Range("BL' + str(Vcount) + '") <> "" Then')
    
    # This spaces out the section of code from the rest
    print()
    
    # This prints out the EFGAOcount variable with the correct VBA syntax
    print('Range("EL' + str(EFGAOcount) + '").Value = ""')
    
    # This prints out the EFGAOcount variable with the correct VBA syntax
    print('Range("EM' + str(EFGAOcount) + '").Value = ""')
    
    # This prints out the EFGAOcount variable with the correct VBA syntax
    print('Range("FE' + str(EFGAOcount) + '").Value = ""')
    
    # This prints out the OFFcountone variable with the correct VBA syntax
    print('Range("FE' + str(OFFcountone) + '").Value = ""')
    
    # This prints out the EFGAOcount variable with the correct VBA syntax
    print('Range("FS' + str(EFGAOcount) + '").Value = ""')
    
    # This prints out the OFFcountone variable with the correct VBA syntax
    print('Range("FS' + str(OFFcountone) + '").Value = ""')
...
while (EFGAOcount < 123):
    ...
    print('Sheets("Kalamein Shop").Range("V' + str(HIcount) + '").Value = Range("EL' + str(EFGAOcount) + '")')
    
    # This prints out the HIcount variable and the EFGAOcount variable with the correct VBA syntax
    print('Sheets("Kalamein Shop").Range("W' + str(HIcount) + '").Value = Range("EM' + str(EFGAOcount) + '")')
    
    # This prints out the HIcount variable and the EFGAOcount variable with the correct VBA syntax
    print('Sheets("Assembly").Range("W' + str(HIcount) + '").Value = Range("FE' + str(EFGAOcount) + '")')
    
    # This prints out the OFFcounttwo variable and the OFFcountone variable with the correct VBA syntax
    print('Sheets("Assembly").Range("W' + str(OFFcounttwo) + '").Value = Range("FE' + str(OFFcountone) + '")')
    
    # This prints out the HIcount variable and the EFGAOcount variable with the correct VBA syntax
    print('Sheets("Prehang").Range("W' + str(HIcount) + '").Value = Range("FS' + str(EFGAOcount) + '")')
    
    # This prints out the OFFcounttwo variable and the OFFcountone variable with the correct VBA syntax
    print('Sheets("Prehang").Range("W' + str(OFFcounttwo) + '").Value = Range("FS' + str(OFFcountone) + '")')